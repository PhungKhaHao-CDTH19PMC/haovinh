...
<script type="text/javascript">
    $("#department_name").multipleSelect({
        ...
        onClose: function () {
            var filterName = JSON.stringify($("#department_name").val())
    ...
    function resetTable() {
        table = $('#department').DataTable({
            ...
            initComplete: function(settings, json) {
                $('#department tbody').on('click', 'input[type="checkbox"]', function(e) {
                ...
                // $('#department').on('click', 'tbody td, thead th:first-child', function(e) {
                ...
                $('thead input[name="select_all"]', table.table().container()).on('click', function(e) {
                    if (this.checked) {
                        $('#department tbody input[type="checkbox"]:not(:checked)').trigger('click');
                    } else {
                        $('#department tbody input[type="checkbox"]:checked').trigger('click');
                    }
